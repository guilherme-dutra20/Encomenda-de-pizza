...
pizzaJson.map((item, index) =>{
    ...
    // preenchendo as informações sobre as pizzas
...
// PREENCHENDO O BOTÃO DE MAIS E MENOS DO CARRINHO
...
function updateCart(){
    ...
    if(cart.length > 0){
      ...
      // ADICIONANDO O TAMANHO DA PIZZA NO CART
        let pizzaSizeName;
    ...
    c('.closed--cart').addEventListener('click', ()=>{
